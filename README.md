...
1. Choose a **network type** (Random / Cluster / Ring)
2. Adjust **β** (transmission rate) and **γ** (recovery rate)
3. Hit **▶ Start** and watch the epidemic unfold
4. The **Markov matrix** and **SIR chart** update in real time
...
1. Click **⚙ Run Monte Carlo Analysis**
2. Wait ~2 seconds while the backend runs 300 scenarios
3. Nodes highlighted with a **yellow ring** are the AI's top recommendations
4. Click **✓ Apply AI Suggestions** to vaccinate them all at once
5. Start the simulation and compare the outcome
